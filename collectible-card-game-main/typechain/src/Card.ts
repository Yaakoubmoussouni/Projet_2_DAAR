...
export interface CardInterface extends utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "getTokensForOwner(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getTokensForOwner",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface Card extends BaseContract {
